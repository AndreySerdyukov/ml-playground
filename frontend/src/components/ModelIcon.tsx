...
const PATHS: Record<string, string[]> = {
  ...
  diamonds: ["M8.5 4.5h7l4 3-7.5 12-7.5-12z", "M4.5 7.5h15", "M8.5 7.5L12 19.5 15.5 7.5"],
  cars: [
  ...
  bayesian: ["M3 18h18", "M3.5 18c4 0 3.5-11 8.5-11s4.5 11 8.5 11", "M12 7.5v10.5"],
  loans: [
  ...
  uplift: ["M3.5 18.5h17", "M4 15.5l4.5-3.5 3.5 2.5 6.5-6", "M14 8.5h4.5v4.5"],
